---
{"dg-publish":true,"permalink":"/js-array-function/"}
---
...
Another way to create a function and assign it to a variable (this process is called [[JS Array Function#Function Expression\|#Function Expression]]) is called **arrow function**, which is similar to [[Python Lambda Function\|Python Lambda Function]]
...
In other words, it’s the shorter version of the [[JS Array Function#Function Expression\|#Function Expression]]:
